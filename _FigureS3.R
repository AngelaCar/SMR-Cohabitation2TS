...
# Men East
plot(x = r_mar_nocov_18p_me$mod_no_cov,
     plot_grid = list(
       c(18, 47, .2),
       c(0, 26, .2)
     ),
...
polygon(
  x = c(max_age_me - .2, max_age_me - .2, max_age_me + ((max_age_me / 100) * 2), 
        max_age_me + ((max_age_me / 100) * 2)),
  y = c(0, 26.5, 26.5, 0),
  col = "white", border = NA
)

plot(x = r_mar_nocov_18p_mw$mod_no_cov,
     plot_grid = list(
       c(18, 47, .2),
       c(0, 25, .2)
     ),
...
plot(x = r_mar_nocov_18p_we$mod_no_cov,
     plot_grid = list(
       c(18, 47, .2),
       c(0, 25, .2)
     ),
...
plot(x = r_mar_nocov_18p_ww$mod_no_cov,
     plot_grid = list(
       c(18, 47, .2),
       c(0, 27, .2)
     ),
