# ---- Figure S7 ----
# Hazard of marriage - Age at cohabitation 15+ ----
...
load("R_marriage_nocov_15plus_me.Rda")
load("R_marriage_nocov_15plus_mw.Rda")
load("R_marriage_nocov_15plus_we.Rda")
load("R_marriage_nocov_15plus_ww.Rda")
...
# Men East
plot(x = r_mar_nocov_15p_me$mod_no_cov,
     plot_grid = list(
       c(15, 47, .2),
       c(0, 26, .2)
     ),
...
plot(x = r_mar_nocov_15p_mw$mod_no_cov,
     plot_grid = list(
       c(15, 47, .2),
       c(0, 25, .2)
     ),
...
plot(x = r_mar_nocov_15p_we$mod_no_cov,
     plot_grid = list(
       c(15, 47, .2),
       c(0, 25, .2)
     ),
...
plot(x = r_mar_nocov_15p_ww$mod_no_cov,
     plot_grid = list(
       c(15, 47, .2),
       c(0, 27, .2)
     ),
