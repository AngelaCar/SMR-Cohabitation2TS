# ---- Figure S9 ----
# Hazard of marriage - first cohabitation only ----
...
# Men East
plot(x = r_mar_nocov_frst_me$mod_no_cov,
     plot_grid = list(
       c(18, 46, .2),
       c(0, 26, .2)
     ),
...
plot(x = r_mar_nocov_frst_mw$mod_no_cov,
     plot_grid = list(
       c(18, 47, .2),
       c(0, 25, .2)
     ),
...
plot(x = r_mar_nocov_frst_we$mod_no_cov,
     plot_grid = list(
       c(18, 43, .2),
       c(0, 25, .2)
     ),
...
plot(x = r_mar_nocov_frst_ww$mod_no_cov,
     plot_grid = list(
       c(18, 44, .2),
       c(0, 27, .2)
     ),
