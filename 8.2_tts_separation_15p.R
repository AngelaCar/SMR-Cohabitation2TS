...
r_sep_nocov_15p_me <- list(
  mod_no_cov = optimal_model,
  data2d = data2d
)
save(r_sep_nocov_15p_me, file = "R_separation_nocov_15plus_me.Rda")
...
# let's add the intervals, the B-splines and their specification
# to the saved results
r_sep_nocov_15p_mw <- list(
  mod_no_cov = optimal_model,
  data2d = data2d
)
save(r_sep_nocov_15p_mw, file = "R_separation_nocov_15plus_mw.Rda")
...
# let's add the intervals, the B-splines and their specification
# to the saved results
r_sep_nocov_15p_we <- list(
  mod_no_cov = optimal_model,
  data2d = data2d
)
save(r_sep_nocov_15p_we, file = "R_separation_nocov_15plus_we.Rda")
...
# let's add the intervals, the B-splines and their specification
# to the saved results
r_sep_nocov_15p_ww <- list(
  mod_no_cov = optimal_model,
  data2d = data2d
)
save(r_sep_nocov_15p_ww, file = "R_separation_nocov_15plus_ww.Rda")
