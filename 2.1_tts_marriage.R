...
table(MenEast[, event_type])
table(WomEast[, event_type])
table(MenWest[, event_type])
table(WomWest[, event_type])
...
r_mar_nocov_18p_me <- list(
  mod_no_cov = optimal_model,
  data2d = data2d
)
save(r_mar_nocov_18p_me, file = "R_int2d_marriage_me.Rda")
...
# let's add the intervals, the B-splines and their specification
# to the saved results
r_mar_nocov_18p_mw <- list(
  mod_no_cov = optimal_model,
  data2d = data2d
)
save(r_mar_nocov_18p_mw, file = "R_int2d_marriage_mw.Rda")
...
# let's add the intervals, the B-splines and their specification
# to the saved results
r_mar_nocov_18p_we <- list(
  mod_no_cov = optimal_model,
  data2d = data2d
)
save(r_mar_nocov_18p_we, file = "R_int2d_marriage_we.Rda")
...
# let's add the intervals, the B-splines and their specification
# to the saved results
r_mar_nocov_18p_ww <- list(
  mod_no_cov = optimal_model,
  data2d = data2d
)
save(r_mar_nocov_18p_ww, file = "R_int2d_marriage_ww.Rda")
